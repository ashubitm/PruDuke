...
*/  
  ...
  public void testContinuosStreams() throws IOException {
    ...
    //TODO Read from JSON Stream and write it to source1 (via - Strings )
 ...
 //   processor.link();
    ...
    List<TestUtils.Pair> matchesNew = listener.getMatches();
    
    
//    matches = listener.getMatches();
    System.out.println("################Bad record count #########"+matchesNew.size()+"\n"+matchesNew.toString()+"no match count "+listener.getNoMatchCount());
