...
private Configuration config;
  ...
  public LuceneDatabase() {
    ...
    this.max_search_hits = 100;
    this.fuzzy_search = true; // on by default
    this.boost_mode = BoostMode.QUERY;
  }

  public IndexWriterConfig getCfg() {
		return cfg;
	}

	public void setCfg(IndexWriterConfig cfg) {
		this.cfg = cfg;
	}
   ...
   */
  // TODO to control only till N records from Index
...
//          new IndexWriterConfig(Version.LUCENE_40, analyzer);
        ...
        System.out.println("CFG Index writer"+cfg.toString());
